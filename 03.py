...
websource = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
for x in range(len(websource)):
    for y in range(len(alphabet)):
        if websource[x] == alphabet[y]:
            if websource[x+1] in upperalphabet:
                if websource[x+2] in upperalphabet:
                    if websource[x+3] in upperalphabet:
                        if websource[x-1] in upperalphabet:
                            if websource[x-2] in upperalphabet:
                                if websource[x-3] in upperalphabet:
                                    if websource [x-4] in alphabet:
                                        if websource [x+4] in alphabet:
                                            print websource[x],
